...
public class ValidationItemControllerV4 {
    ...
    //private final ItemValidator itemValidator; 사용X
    ...
    // SpringBoot가 자동으로 global Validator를 Bean으로 등록
    // @Validated -> 어노테이션 기반 global Validator 실행 -> Item을 검증
    // @Validated와 @Valid 둘다 사용 가능
    //@PostMapping("/add")
    ...
    //groups가 SaveCheck.class로 포함되어 있는 항목만 검증
    //@PostMapping("/add")
